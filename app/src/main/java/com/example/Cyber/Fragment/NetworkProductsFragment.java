...
public class NetworkProductsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_soaps_sanitary, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.toiletriesRecview);
    ...
    public void onResume() {
        super.onResume();
        AllProductsAdapter.currentFragment = getString(R.string.category5);
