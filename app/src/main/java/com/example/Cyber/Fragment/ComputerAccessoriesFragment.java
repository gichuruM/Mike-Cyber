...
public class ComputerAccessoriesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_computer_accessories, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.computerAccessoriesRecview);
    ...
    public void onResume() {
        super.onResume();
        AllProductsAdapter.currentFragment = getString(R.string.category6);
